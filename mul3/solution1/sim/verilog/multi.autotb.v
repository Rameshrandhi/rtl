// ==============================================================
// File generated on Fri Mar 17 11:18:39 IST 2023
...
`define AUTOTB_DUT      multi
`define AUTOTB_DUT_INST AESL_inst_multi
`define AUTOTB_TOP      apatb_multi_top
`define AUTOTB_LAT_RESULT_FILE "multi.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "multi.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_multi_top
...
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.multi.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.multi.autotvin_B.dat"
`define AUTOTB_TVOUT_C  "../tv/cdatafile/c.multi.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "../tv/rtldatafile/rtl.multi.autotvout_C.dat"
module `AUTOTB_TOP;
